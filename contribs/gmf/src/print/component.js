...
class Controller {
  ...
  togglePrintPanel_(active) {
    if (active) {
      ...
      if (!this.postComposeListenerKey_) {
        throw 'Missing postComposeListenerKey';
      }
      if (!this.pointerDragListenerKey_) {
        throw 'Missing pointerDragListenerKey';
      }
      if (!this.mapViewResolutionChangeKey_) {
        throw 'Missing mapViewResolutionChangeKey';
      }
  ...
  onPointerDrag_(e) {
    ...
    if (!this.onDragPreviousMousePosition_) {
      throw 'Missing onDragPreviousMousePosition';
    }
        ...
        if (layer instanceof olLayerTile) {
          ...
          layerNames.forEach((name) => {
            ...
            if (!source.serverType_) {
              throw 'Missing source.serverType_';
            }
